...
@section('content')
    <div class="container-sm my-5">
        <form action="{{ route('barang.update', ['list' => $list->id]) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="harga_barang" id="harga_arang" value="{{ old('harga_barang') }}" placeholder="Enter harga barang">
                            @error('harga_barang')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="deskripsi_barang" id="deskripsi_barang" value="{{old('deskripsi_barang')}}" placeholder="Enter deskripsi Barang">
